...
lvk::surface lvk::surface::create(const lvk::instance &instance, const lvk::glfw_window &window) {
	VkSurfaceKHR surface;
	if (*instance == VK_NULL_HANDLE) {
		throw lvk::vk_exception("lvk::surface::create: Vulkan instance passed is not initialized");
	}
